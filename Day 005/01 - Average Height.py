...
#You are going to write a program that calculates the average student height from a List 
#of heights.
...
avg_height = round(sum_of_heights / count_of_inputs)

print(f"total height = {sum_of_heights}")
print(f"number of students = {count_of_inputs}")
